...
<?php
    ...
    $query = mysqli_query($kon, "SELECT * FROM komentar k inner join koleksi a on a.id_koleksi=k.id_koleksi where id_komentar=$id_komentar");
...
?>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            <label>koleksi:</label>
            <input name="nama" value="<?php echo $judul_koleksi; ?>" type="text" class="form-control" disabled>
        </div>
        <div class="form-group">
            <label>Nama:</label>
