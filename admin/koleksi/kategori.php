...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="card-columns">
            ...
            <a href="index.php?halaman=koleksi&kategori=<?php echo $data['id_kategori'];?>"><img class="card-img-top" src="koleksi/gambar_kategori/<?php echo $data['gambar_kategori'];?>" alt="Card image cap"></a>
                <div class="card-body text-center">
                <a href="index.php?halaman=koleksi&kategori=<?php echo $data['id_kategori'];?>"><h5 class="card-title"><?php echo $data['nama_kategori'];?></h5></a>
