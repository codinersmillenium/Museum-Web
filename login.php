...
$pesan="";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $cek_admin = "select * from admin where username='".$username."' and password='".$password."' limit 1";
        $hasil_cek = mysqli_query ($kon,$cek_admin);
        ...
        if ($jumlah>0){
            if ($row["status"]==1){
                ...
                header("Location:admin/index.php?halaman=kategori");
                    ...
                    $pesan="<div class='alert alert-warning'><strong>Gagal!</strong> Status admin tidak aktif.</div>";
                }
